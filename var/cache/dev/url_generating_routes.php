...
return [
    ...
    'modif_panier' => [['id', 'prix', 'action'], ['_controller' => 'App\\Controller\\PanierController::ModifPanier'], [], [['variable', '/', '[^/]++', 'action', true], ['variable', '/', '[^/]++', 'prix', true], ['variable', '/', '[^/]++', 'id', true], ['text', '/modifpanier']], [], []],
    'remove_all' => [['id', 'prix'], ['_controller' => 'App\\Controller\\PanierController::removeAll'], [], [['variable', '/', '[^/]++', 'prix', true], ['variable', '/', '[^/]++', 'id', true], ['text', '/delete']], [], []],
