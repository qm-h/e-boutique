...
return [
    ...
    'add_panier' => [[], ['_controller' => 'App\\Controller\\PanierController::add'], [], [['text', '/panier/add']], [], []],
    'cart_remove' => [['id', 'prix'], ['_controller' => 'App\\Controller\\PanierController::remove'], [], [['variable', '/', '[^/]++', 'prix', true], ['variable', '/', '[^/]++', 'id', true], ['text', '/panier/remove']], [], []],
